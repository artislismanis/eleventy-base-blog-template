...
import themePlugin from './plugin.mjs';

// Re-export metadata
export { metadata };

// Re-export plugin as named export
export { themePlugin };
...
export function init(eleventyConfig, options = {}) {
	...
	// Configure all cascade systems (data + assets)
...
export { configureNunjucks, ThemeAwareLoader } from './eleventy/template-loader.mjs';

export { getFeatureEntries } from './build/feature-entries.mjs';
...
// Default export - provide both plugin and manual init
export default {
	// Recommended: Use as Eleventy plugin (simplest setup)
	plugin: themePlugin,

	// Alternative: Manual setup (more control)
	init,
	metadata,

	// Direct access to theme components
	filters,
	transforms,
	shortcodes,
};
